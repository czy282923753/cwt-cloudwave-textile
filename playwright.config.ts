...
export default defineConfig({
  ...
  webServer: {
    command:
      "pnpm db:migrate && pnpm db:seed && pnpm db:seed:fixtures && pnpm exec tsx scripts/seed-e2e-retryable-asset.ts && pnpm exec tsx scripts/seed-e2e-block-projection.ts && pnpm build && pnpm start --hostname 127.0.0.1 --port 3100",
