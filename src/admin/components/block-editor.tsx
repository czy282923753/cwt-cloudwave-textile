...
export function BlockEditor(props: Readonly<BlockEditorProps>) {
  ...
  return (
    <section className="grid min-w-0 gap-5 rounded-2xl border border-white/10 bg-slate-900 p-4 sm:p-6" data-block-editor={props.entityType}>
