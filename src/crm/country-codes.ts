export const COUNTRY_CODE_ERROR_MESSAGE =
...
export type IsoAlpha2CountryCode = (typeof COUNTRY_OPTIONS)[number]["code"];
...
export function isIsoAlpha2CountryCode(
  value: string,
): value is IsoAlpha2CountryCode {
  return /^[A-Z]{2}$/.test(value) && countryCodeSet.has(value);
}
