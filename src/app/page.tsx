...
const capabilities = [
  ["China textile supply chain", "Access multiple fabric categories and coordinated sourcing support through Guangzhou and wider China resources."],
  ...
  ["Sampling to export", "Move from fabric selection toward custom development, sample coordination, quality follow-up, and export service."],
] as const;

export default async function Home() {
  const [products, applications, libraryEntries, contents] = await Promise.all([
  ...
  const organizationSchema = {
    ...
    legalName: "Guangzhou CloudWave Textile Co., Ltd.",
      ...
      <main>
        <section className="relative overflow-hidden border-b border-stone-200 bg-[#f4f0e5]">
          ...
          <div className="site-container relative grid min-h-[45rem] items-center gap-12 py-20 lg:grid-cols-[1.15fr_.85fr]">
            <div>
              <p className="eyebrow">CloudWave Textile · Guangzhou, China</p>
