...
export default function ResourcesPage() {
  const resources = [
    ...
    ["China Textile Guide", "/china-textile-guide", "Learn about China's textile ecosystem, regional clusters, Guangzhou Zhongda market, and supply-chain context."],
