...
export async function PublicFooter() {
  ...
  return (
    <footer className="bg-[#103e37] text-white">
      ...
      <div className="border-t border-white/10"><div className="site-container flex flex-wrap justify-between gap-3 py-5 text-xs text-white/55"><span>© {new Date().getFullYear()} {legalName ?? "CloudWave Textile"}</span><span><Link href="/privacy/">Privacy &amp; uploads</Link> · English at root</span></div></div>
    </footer>
  );
}
