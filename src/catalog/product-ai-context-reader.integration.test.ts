...
describe.skipIf(postgresUrl === undefined)("ProductAiDraftReaderV1 on PostgreSQL", () => {
  ...
  beforeEach(async () => {
    await db().execute(sql`truncate table ${editorialRevisions}, ${productAssets}, ${assets}, ${productLocalizations}, ${productTaxonomyTerms}, ${products}, ${taxonomyTermLocalizations}, ${taxonomyTerms}, ${users} cascade`);
